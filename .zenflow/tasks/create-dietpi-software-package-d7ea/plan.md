...
If Planning didn't replace this step, execute the tasks in `.zenflow/tasks/create-dietpi-software-package-d7ea/plan.md`, updating checkboxes as you go. Run planned tests/lint and record results in plan.md.
